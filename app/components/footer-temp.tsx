...
export default function FooterTemp() {
  return (
    <footer className="border-t border-slate-200 bg-[#f5f5f3] px-4 pb-[calc(2.5rem+env(safe-area-inset-bottom))] pt-8 text-slate-600 min-[600px]:px-10 min-[600px]:pb-10 min-[600px]:pt-10 lg:px-16">
