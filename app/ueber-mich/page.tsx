      ...
      <section className="relative isolate min-h-[90vh] overflow-hidden bg-[linear-gradient(135deg,#f8fbff_0%,#edf4fb_45%,#e6eef8_100%)] px-4 pb-16 pt-16 sm:pt-20 min-[600px]:px-6 min-[1024px]:flex min-[1024px]:items-center min-[1024px]:pb-20 min-[1024px]:pt-10">
        ...
        <div className="relative z-20 mx-auto grid w-full max-w-[1600px] gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <Reveal className="w-full max-w-none min-[1024px]:max-w-[672px]">
            <p className="inline-flex rounded-full border border-[#145da0]/10 bg-white/80 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#145da0] backdrop-blur min-[600px]:px-4 min-[600px]:py-2 min-[600px]:text-xs min-[600px]:tracking-[0.28em]">
               Über mich
            </p>
